...
- 详见 [AI 面试全链路实施文档](../05-方案设计-分模块/04-语音面试/AI%20面试全链路重构%20·%20完整实施文档（V2%20·%20强化版）.md)
...
- `202608201435-moyun-db-ddl-moyun-db.sql`：基础建表（188 表，create table if not exists 幂等）
