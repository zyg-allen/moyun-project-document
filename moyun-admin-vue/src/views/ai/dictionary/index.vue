...
const loadList = async () => {
  loading.value = true
  try {
    const response = await request({ url: '/cms/ai/domain-dictionary/list', method: 'get' })
...
const deleteDictionary = async (id) => {
  try {
    ...
    const response = await request({ url: `/cms/ai/domain-dictionary/delete/${id}`, method: 'delete'})
...
const submitForm = async () => {
  ...
  try {
    const url = editMode.value ? '/cms/ai/domain-dictionary/update' : '/cms/ai/domain-dictionary/create'
...
const reload = async () => {
  try {
    const response = await request({ url: '/cms/ai/domain-dictionary/reload', method: 'post'})
...
<style scoped src="@/views/ai/styles/domain-dictionary-manage.css"></style>
