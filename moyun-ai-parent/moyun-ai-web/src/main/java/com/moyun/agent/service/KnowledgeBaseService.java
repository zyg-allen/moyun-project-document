...
import com.moyun.agent.dto.RetrievalTestRequest;
...
public interface KnowledgeBaseService extends IService<KnowledgeBase> {
     ...
     * @throws Exception 处理异常
     */
    void processKnowledge(Long knowledgeId, com.moyun.agent.entity.KnowledgeConfig config) throws Exception;
     ...
     * @param config 知识库配置
     */
    void processKnowledgeWithConfig(Long documentId, com.moyun.agent.entity.KnowledgeLibraryConfig config);
