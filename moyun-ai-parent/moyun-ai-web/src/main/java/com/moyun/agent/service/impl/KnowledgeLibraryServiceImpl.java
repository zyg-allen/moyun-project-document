...
import com.moyun.agent.mapper.KnowledgeLibraryConfigMapper;
import com.moyun.agent.mapper.KnowledgeLibraryMapper;
...
public class KnowledgeLibraryServiceImpl extends ServiceImpl<KnowledgeLibraryMapper, KnowledgeLibrary> implements KnowledgeLibraryService {
    ...
    @Override
    public List<com.moyun.agent.dto.RetrievalTestResult> testRetrieval(Long libraryId, com.moyun.agent.dto.RetrievalTestRequest request) {
        // 验证知识库存在
