/*
 ...
 Source Host           : rm-yulnsxu5.mysql.rds.aliyuncs.com:3306
 Source Schema         : allen-zyg-ai

 Target Server Type    : MySQL
 Target Server Version : 80028 (8.0.28)
 File Encoding         : 65001

 Date: 23/01/2026 15:52:43
*/
...
-- ----------------------------
DROP TABLE IF EXISTS `agent_dictionary_relation`;
CREATE TABLE `agent_dictionary_relation`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- ----------------------------
DROP TABLE IF EXISTS `agent_workflow_relation`;
CREATE TABLE `agent_workflow_relation`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `agent_id` bigint NOT NULL COMMENT '智能体ID',
...
-- ----------------------------
DROP TABLE IF EXISTS `chart_recommendation_rule`;
CREATE TABLE `chart_recommendation_rule`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- ----------------------------
DROP TABLE IF EXISTS `data_insight`;
...
-- ----------------------------
DROP TABLE IF EXISTS `document_chunk_metadata`;
...
-- ----------------------------
DROP TABLE IF EXISTS `domain_dictionary`;
...
-- ----------------------------
DROP TABLE IF EXISTS `knowledge_config`;
...
-- ----------------------------
DROP TABLE IF EXISTS `knowledge_config_template`;
CREATE TABLE `knowledge_config_template`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `knowledge_library_config`;
CREATE TABLE `knowledge_library_config`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '配置ID',
...
-- ----------------------------
DROP TABLE IF EXISTS `reference_feedback`;
CREATE TABLE `reference_feedback`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'laomao', '$2a$10$h7w6U9C89BZKob4bLpMSluMif1gyUwDhAtGcSfKNyvYwSpjl8ZxfS', '老猫', NULL, NULL, NULL, 1, '2026-01-23 14:27:41', '0:0:0:0:0:0:0:1', '2025-11-25 12:41:36', '2026-01-23 14:27:41');
