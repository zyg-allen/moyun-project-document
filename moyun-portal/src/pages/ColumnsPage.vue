...
<template>
  <div class="min-h-screen flex flex-col" style="background-color: var(--theme-bg);">
    ...
    <!-- 页头：轻量标题 + 搜索 + 创建（与首页风格统一，去掉深色 Hero 横幅） -->
    <div class="pt-6 sm:pt-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-4">
          <div>
            <h1 class="text-xl sm:text-2xl font-bold" style="color: var(--theme-text);">专栏</h1>
            <p class="mt-1 text-sm" style="color: var(--theme-text-secondary);">按主题聚合文章，持续连载，订阅追更，构建你的知识体系</p>
          </div>
          <button
            @click="gotoCreate"
            class="self-start sm:self-auto inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium text-white transition hover:opacity-90"
        ...
        <!-- 搜索框 -->
        <div class="max-w-xl rounded-xl p-2 flex items-center border mb-4" style="background-color: var(--theme-surface); border-color: var(--theme-border);">
