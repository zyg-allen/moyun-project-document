...
public class CurrentTimeTool implements ToolExecutor {
    ...
    public ToolResult execute(ToolContext context, Map<String, Object> params) {
        try {
            String timezone = params.containsKey("timezone") ? asString(params, "timezone") : "Asia/Shanghai";
            String format = params.containsKey("format") ? asString(params, "format") : "yyyy-MM-dd HH:mm:ss";
