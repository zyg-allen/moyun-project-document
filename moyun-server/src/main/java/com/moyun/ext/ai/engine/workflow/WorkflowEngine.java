...
public class WorkflowEngine {
    ...
    /** AI 工作流并行分支执行线程池（由 Spring 容器管理，替代历史 static final 静态线程池） */
     ...
     * 构造函数注入。
     *
     * <p>{@code workflowParallelExecutor} 显式通过 {@code @Qualifier} 绑定到
     * {@code com.moyun.ext.ai.config.AsyncConfig#workflowParallelExecutor} Bean，
     * 避免与 core 模块的 {@code applicationTaskExecutor}（@Primary）产生歧义。</p>
     */
    public WorkflowEngine(WorkflowMapper workflowMapper,
