...
public class DataQueryServiceImpl implements DataQueryService {
    ...
    public DataQueryResponse intelligentQuery(DataQueryRequest request) {
        ...
        try {
            ...
            if (!com.moyun.ext.ai.util.RateLimiter.tryAcquire(rateLimitKey, 20)) {
                int remaining = com.moyun.ext.ai.util.RateLimiter.getRemainingCount(rateLimitKey, 20);
    ...
    private String generateElasticsearchDSL(String naturalQuery, 
        ...
        try {
            // 1. 获取索引详细信息
            List<com.moyun.ext.ai.vo.TableInfoVO> indicesInfo = 
            ...
            // 3. 为每个索引构建详细信息
            for (com.moyun.ext.ai.vo.TableInfoVO indexInfo : indicesInfo) {
                ...
                try {
                    // 获取字段mapping
                    com.moyun.ext.ai.vo.TableSchemaVO schema = 
                    ...
                    prompt.append("字段列表：\n");
                    int fieldNum = 1;
                    for (com.moyun.ext.ai.vo.TableSchemaVO.ColumnSchema field : schema.getColumns()) {
...
// ...
    ...
    private static class IndexScore {
        com.moyun.ext.ai.vo.TableInfoVO index;
        int score;
        
        IndexScore(com.moyun.ext.ai.vo.TableInfoVO index, int score) {
            this.index = index;
            this.score = score;
        }
    }
