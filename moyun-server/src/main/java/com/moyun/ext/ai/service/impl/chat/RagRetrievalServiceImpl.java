...
import com.moyun.ext.ai.model.RerankResult;
...
import com.moyun.ext.ai.service.chat.ContentScoringService;
...
import com.moyun.ext.ai.util.TextProcessingUtils;
...
public class RagRetrievalServiceImpl implements RagRetrievalService {
    ...
    private com.moyun.ext.ai.service.QueryTypeClassifier queryTypeClassifier;
    ...
    private List<Content> retrieveByKnowledgeBaseWeights(
        ...
        for (Map.Entry<String, Double> entry : effectiveWeights.entrySet()) {
            ...
            if (isVectorSearch) {
                ...
                // BM25检索
                List<EmbeddingMatch<TextSegment>> bm25Matches = embeddingStore.bm25Search(
        ...
        try {
            ...
            if (enableHybridSearch) {
                ...
                for (String kbId : idStrings) {
                    List<dev.langchain4j.store.embedding.EmbeddingMatch<dev.langchain4j.data.segment.TextSegment>> bm25Results = embeddingStore
