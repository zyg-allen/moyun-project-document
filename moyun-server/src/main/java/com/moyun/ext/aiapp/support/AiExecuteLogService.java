...
import com.moyun.ext.aiapp.entity.AiExecuteLog;
import com.moyun.ext.aiapp.mapper.AiExecuteLogMapper;
...
public class AiExecuteLogService {
    ...
    public void record(String requestId, String sceneCode, String handlerName, String bindType,
                       com.moyun.ext.aiapp.model.AiMetadata metadata,
     ...
     */
    private java.math.BigDecimal calculateCostYuan(com.moyun.ext.aiapp.model.AiMetadata metadata) {
