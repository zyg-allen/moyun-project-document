 ...
 * {@link com.moyun.ext.aiapp.service.AiGatewayService} 统一网关（治理：限流/熔断/缓存/日志/降级）
 * 路由到对应 {@link com.moyun.ext.aiapp.handler.AiSceneHandler}。Handler 内部如需调底层 LLM
 * 用 {@link com.moyun.ext.aiapp.handler.AbstractAiSceneHandler#chatJson}（Handler 内部方法）。
...
public class AiSceneJsonClient {
    ...
    private Map<String, Object> unwrapStructured(Object data) {
        ...
        if (data instanceof com.moyun.ext.aiapp.model.data.GenericSceneData generic
