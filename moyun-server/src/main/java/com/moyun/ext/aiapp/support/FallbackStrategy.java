...
public class FallbackStrategy {
    ...
    public AiExecuteResponse<?> executeFallback(String scene, String configuredFallback, Exception e) {
        ...
        com.moyun.ext.aiapp.model.data.GenericSceneData fallbackData =
                new com.moyun.ext.aiapp.model.data.GenericSceneData();
        fallbackData.setContent(null);
        fallbackData.setSource("fallback");
        AiExecuteResponse<Object> fallbackResp = new AiExecuteResponse<>();
        fallbackResp.setCode(AiErrorCodes.SUCCESS);
        fallbackResp.setMsg("fallback");
        fallbackResp.setData(fallbackData);
        return fallbackResp;
    }
