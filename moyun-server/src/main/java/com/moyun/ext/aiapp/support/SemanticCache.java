...
public class SemanticCache {
    ...
    private com.moyun.ext.aiapp.model.AiMetadata markFromCache(AiExecuteResponse<?> response) {
        com.moyun.ext.aiapp.model.AiMetadata metadata = response.getMetadata();
        if (metadata == null) {
            metadata = new com.moyun.ext.aiapp.model.AiMetadata();
        }
