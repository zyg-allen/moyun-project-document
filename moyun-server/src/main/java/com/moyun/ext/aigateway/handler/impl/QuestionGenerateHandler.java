...
import com.moyun.ext.aigateway.model.data.QuestionSceneData.GeneratedQuestion;
...
public class QuestionGenerateHandler extends AbstractAiSceneHandler {
    ...
    public String getSceneCode() {
        return AiSceneEnum.QUESTION_GENERATE.getCode();
    }
    ...
    private List<String> parseJsonStringArray(String raw) {
        ...
        try {
            ...
            log.warn("[aigateway:{}] JSON(数组)解析失败: {}", getSceneCode(), e.getMessage());
            return null;
        }
    }
