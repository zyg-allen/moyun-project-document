...
import com.moyun.common.exception.system.CustomException;
import com.moyun.core.base.AjaxResult;
import com.moyun.core.base.entity.SysRole;
import com.moyun.core.base.entity.SysUser;
import com.moyun.ext.flowable.common.constant.ProcessConstants;
import com.moyun.ext.flowable.common.enums.FlowComment;
import com.moyun.ext.flowable.domain.dto.FlowCommentDto;
import com.moyun.ext.flowable.domain.dto.FlowNextDto;
import com.moyun.ext.flowable.domain.dto.FlowTaskDto;
import com.moyun.ext.flowable.domain.dto.FlowViewerDto;
import com.moyun.ext.flowable.domain.vo.FlowQueryVo;
import com.moyun.ext.flowable.domain.vo.FlowTaskVo;
import com.moyun.ext.flowable.factory.FlowServiceFactory;
import com.moyun.ext.flowable.flow.CustomProcessDiagramGenerator;
import com.moyun.ext.flowable.flow.FindNextNodeUtil;
import com.moyun.ext.flowable.flow.FlowableUtils;
...
public class FlowTaskServiceImpl extends FlowServiceFactory implements IFlowTaskService {
    ...
    public void taskReturn(FlowTaskVo flowTaskVo) {
        ...
        // 设置回退意见
        currentTaskIds.forEach(currentTaskId -> taskService.addComment(currentTaskId, task.getProcessInstanceId(), FlowComment.REBACK, flowTaskVo.getComment()));
