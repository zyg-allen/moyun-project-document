...
public interface GenTableMapper {
     ...
     * @return 分页结果
     */
    public IPage<GenTable> selectGenTablePage(IPage<GenTable> page, @Param("query") GenTable genTable);
     ...
     * @return 分页结果
     */
    public IPage<GenTable> selectDbTablePage(IPage<GenTable> page, @Param("query") GenTable genTable);
