...
/**
 * 面试会员订单（接入公共支付通道，bizType=interview_vip 平台直收类）
 *
 * <p>链路：面试频道选套餐下单（快照 name/duration，clientUuid 幂等）→ 落 pending 单 →
 ...
 */
@Data
@TableName("portal_interview_vip_order")
public class PortalInterviewVipOrder {
    ...
    /** 套餐ID（portal_interview_vip_package.id） */
