...
public class SysDeptController extends BaseController {
    ...
    public AjaxResult excludeChild(@Parameter(description = "部门ID") @PathVariable(value = "deptId", required = false) Long deptId) {
     ...
     * 获取部门下拉树列表
     */
    @Operation(summary = "获取部门下拉树列表", description = "获取部门树形结构用于下拉选择")
    ...
    public AjaxResult getInfo(@Parameter(description = "部门ID") @PathVariable Long deptId) {
