...
public class SysUserController extends BaseController
{
    ...
    @Operation(summary = "下载导入模板", description = "下载用户数据导入模板")
     ...
     * 根据用户编号获取详细信息
     */
    @Operation(summary = "获取用户详情", description = "根据用户ID获取用户详细信息，包括岗位和角色信息")
     ...
     * 根据用户编号获取授权角色
     */
    @Operation(summary = "获取用户授权角色", description = "获取用户已授权的角色列表")
    @PreAuthorize("@ss.hasPermi('system:user:query')")
     ...
     * 获取部门树列表
     */
    @Operation(summary = "获取部门树列表", description = "获取部门树形结构数据")
    @PreAuthorize("@ss.hasPermi('system:user:list')")
    @GetMapping("/deptTree")
