...
-- 插入默认管理员账号（密码为：admin123，使用 BCrypt 加密）
...
-- 插入测试用户账号（密码为：user123）
INSERT INTO `sys_user` (`username`, `password`, `nickname`, `email`, `status`)
VALUES ('user', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EH', '测试用户', 'user@example.com', 1);